...
class OrderServiceTest {
    ...
    void OrderService_getAll_returns_mapped_dtos_Test() {
        ...
        // Act
        List<OrdersDto> result = service.getAll(0, 20);
    ...
    @Test
    void OrderService_getAll_returns_paged_dtos_when_page_specified_Test() {
        // Arrange
        Order entity = new Order();
        entity.setOrderID(10);
        OrdersDto dto = new OrdersDto();
        ...
        // Act
        List<OrdersDto> result = service.getAll(2, 10);

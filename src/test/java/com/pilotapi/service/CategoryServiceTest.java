...
class CategoryServiceTest {
    ...
    void CategoryService_getAll_returns_mapped_dtos_Test() {
        ...
        // Act
        List<CategoriesDto> result = service.getAll(0, 20);
    ...
    @Test
    void CategoryService_getAll_returns_paged_dtos_when_page_specified_Test() {
        // Arrange
        Category entity = new Category();
        entity.setCategoryID(1);
        CategoriesDto dto = new CategoriesDto();
        ...
        // Act
        List<CategoriesDto> result = service.getAll(2, 10);
